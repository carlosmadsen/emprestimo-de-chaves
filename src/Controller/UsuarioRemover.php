...
class UsuarioRemover implements RequestHandlerInterface
{
    ...
    public function handle(ServerRequestInterface $request): ResponseInterface
    {
        try {
            ...
            if (is_null($usuario)) {
                 throw new Exception("Não foi possível localizar o usuário.", 1);
            }
            ...
            if (count($emprestimos) > 0) {
                throw new Exception('Não é permitido remover um usuário que tem empréstimos de chave em aberto.');
            }  
